...
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| ivec2 **textureSize** (sampler2D_type sampler, int lod)                      | Get the size of a texture.                                          |
|                                                                              |                                                                     |
| ivec3 **textureSize** (sampler2DArray_type sampler, int lod)                 |                                                                     |
|                                                                              |                                                                     |
| ivec3 **textureSize** (sampler3D sampler, int lod)                           |                                                                     |
|                                                                              |                                                                     |
| ivec2 **textureSize** (samplerCube sampler, int lod)                         |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| gvec4_type **texture** (gsampler2D_type sampler, vec2 p [, float bias])      | Perform a texture read.                                             |
|                                                                              |                                                                     |
| gvec4_type **texture** (gsampler2DArray_type sampler, vec3 p [, float bias]) |                                                                     |
|                                                                              |                                                                     |
| gvec4_type **texture** (gsampler3D_type sampler, vec3 p [, float bias])      |                                                                     |
|                                                                              |                                                                     |
| vec4 **texture** (samplerCube sampler, vec3 p [, float bias])                |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| gvec4_type **textureProj** (gsampler2D_type sampler, vec3 p [, float bias])  | Perform a texture read with projection.                             |
|                                                                              |                                                                     |
| gvec4_type **textureProj** (gsampler2D_type sampler, vec4 p [, float bias])  |                                                                     |
|                                                                              |                                                                     |
| gvec4_type **textureProj** (gsampler3D_type sampler, vec4 p [, float bias])  |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| gvec4_type **textureLod** (gsampler2D_type sampler, vec2 p, float lod)       | Perform a texture read at custom mipmap.                            |
|                                                                              |                                                                     |
| gvec4_type **textureLod** (gsampler2DArray_type sampler, vec3 p, float lod)  |                                                                     |
|                                                                              |                                                                     |
| gvec4_type **textureLod** (gsampler3D_type sampler, vec3 p, float lod)       |                                                                     |
|                                                                              |                                                                     |
| vec4 **textureLod** (samplerCube_type sampler, vec3 p, float lod)            |                                                                     |
|                                                                              |                                                                     |
| vec4 **textureLod** (samplerCubeArray_type sampler, vec4 p, float lod)       |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| gvec4_type **textureProjLod** (gsampler2D_type sampler, vec3 p, float lod)   | Performs a texture read with projection/LOD.                        |
|                                                                              |                                                                     |
| gvec4_type **textureProjLod** (gsampler2D_type sampler, vec4 p, float lod)   |                                                                     |
|                                                                              |                                                                     |
| gvec4_type **textureProjLod** (gsampler3D_type sampler, vec4 p, float lod)   |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| gvec4_type **texelFetch** (gsampler2D_type sampler, ivec2 p, int lod)        | Fetches a single texel using integer coordinates.                   |
|                                                                              |                                                                     |
| gvec4_type **texelFetch** (gsampler2DArray_type sampler, ivec3 p, int lod)   |                                                                     |
|                                                                              |                                                                     |
| gvec4_type **texelFetch** (gsampler3D_type sampler, ivec3 p, int lod)        |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
| gvec4_type **textureGather** (gsampler2D_type sampler, vec2 p [, int comps]) | Gathers four texels from a texture.                                 |
|                                                                              | Use ``comps`` within range of 0..3 to                               |
| gvec4_type **textureGather** (gsampler2DArray sampler, vec3 p [, int comps]) | define which component (x, y, z, w) is returned.                    |
|                                                                              | If ``comps`` is not provided: 0 (or x-component) is used.           |
| vec4 **textureGather** (samplerCube sampler, vec3 p [, int comps])           |                                                                     |
+------------------------------------------------------------------------------+---------------------------------------------------------------------+
